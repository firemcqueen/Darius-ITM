...
def shift_by_letter(letter, letter_shift):
    ...
    if letter == " ":
        ...
        ascii_offset = ord("A")
        shift_offset = ord(letter_shift) - ascii_offset
        letter_index = ord(letter) - ascii_offset
        shifted_index = (letter_index + shift_offset) % 26
        shifted_letter = chr(shifted_index + ascii_offset)
